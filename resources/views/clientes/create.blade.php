        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-6">Criar Novo Cliente</h3>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select id="tipo_cliente" name="tipo_cliente" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                            <option value="pf" {{ old('tipo_cliente', 'pf') === 'pf' ? 'selected' : '' }}>Pessoa Física</option>
                                            <option value="pj" {{ old('tipo_cliente') === 'pj' ? 'selected' : '' }}>Pessoa Jurídica</option>
                                        </select>
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="telefone_secundario" class="block mt-1 w-full" type="tel" name="telefone_secundario" :value="old('telefone_secundario')" />
