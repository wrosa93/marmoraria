                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <p class="mt-1 text-base text-gray-900 dark:text-gray-100">{{ $material->codigo }}</p>
                        </div>
                        <div>
                            <span class="block text-sm font-medium text-gray-500 dark:text-gray-400 uppercase">Nome</span>
                            <p class="mt-1 text-base text-gray-900 dark:text-gray-100">{{ $material->nome }}</p>
                        </div>
                        <div>
                            <span class="block text-sm font-medium text-gray-500 dark:text-gray-400 uppercase">Tipo</span>
                            <p class="mt-1 text-base text-gray-900 dark:text-gray-100">{{ $material->tipo ?? 'Não informado' }}</p>
                        </div>
                        <div>
                            <span class="block text-sm font-medium text-gray-500 dark:text-gray-400 uppercase">Acabamento</span>
                            <p class="mt-1 text-base text-gray-900 dark:text-gray-100">{{ $material->acabamento ?? 'Não informado' }}</p>
                        </div>
                        <div>
                            <span class="block text-sm font-medium text-gray-500 dark:text-gray-400 uppercase">Cor</span>
                            <p class="mt-1 text-base text-gray-900 dark:text-gray-100">{{ $material->cor ?? 'Não informado' }}</p>
                        </div>
                        <div>
                            <span class="block text-sm font-medium text-gray-500 dark:text-gray-400 uppercase">Espessura padrão</span>
                            <p class="mt-1 text-base text-gray-900 dark:text-gray-100">
                                {{ $material->espessura_padrao_mm ? number_format($material->espessura_padrao_mm, 2, ',', '.') . ' mm' : 'Não informado' }}
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-base text-gray-900 dark:text-gray-100">{{ $material->updated_at->format('d/m/Y H:i') }}</p>
                        </div>
                        <div class="md:col-span-2">
                            <span class="block text-sm font-medium text-gray-500 dark:text-gray-400 uppercase">Descrição</span>
                            <p class="mt-1 text-base text-gray-900 dark:text-gray-100">{{ $material->descricao ?? 'Sem descrição' }}</p>
                        </div>
                    </div>
