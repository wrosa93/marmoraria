        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-6">Criar Novo Material</h3>
                    ...
                    <form action="{{ route("materiais.store") }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="preco_m2" class="block mt-1 w-full" type="number" step="0.01" name="preco_m2" :value="old("preco_m2")" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="espessura_mm" class="block mt-1 w-full" type="number" step="1" name="espessura_mm" :value="old("espessura_mm")" required />
