<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __("Editar Serviço: ") . $servico->descricao }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-6">Editar Serviço: {{ $servico->descricao }}</h3>
                    ...
                    <form action="{{ route("servicos.update", $servico) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="descricao" class="block mt-1 w-full" type="text" name="descricao" :value="old("descricao", $servico->descricao)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="preco_unitario" class="block mt-1 w-full" type="number" step="0.01" name="preco_unitario" :value="old("preco_unitario", $servico->preco_unitario)" required />
